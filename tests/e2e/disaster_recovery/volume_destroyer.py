...
class VolumeDestroyer(DisasterSimulator):
    ...
    def _destroy_docker_volume(self, container_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = ["docker", "inspect", container_name, "--format", "{{range .Mounts}}{{.Name}}{{end}}"]
    ...
    def _destroy_k8s_volume(self, pod_name: str, namespace: str = "default") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            subprocess.run(["kubectl", "delete", "pod", pod_name, "-n", namespace], timeout=30)
